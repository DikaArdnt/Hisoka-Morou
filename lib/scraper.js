...
function getSizefromUrl (url) {          //Url Nya Harus Yang Langsung Ke File Nya
    return new Promise((res, rej) => {
        ...
        req.once("response", r => {
            ...
            hasil = c / 1048576
            if(!isNaN(c)) res(hasil.toFixed(2))
            else rej(" - ")
        });
...
module.exports = { pinterest, wallpaper, wikimedia, quotesAnime, aiovideodl, umma, ringtone, getSizefromUrl }
